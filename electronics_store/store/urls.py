...
urlpatterns = [
    ...
    path('admin/', admin.site.urls),
    path('register/', include('registration.urls')),  # Пример маршрута регистрации
    path('login/', include('registration.urls')),     # Пример маршрута входа
    path('logout/', include('registration.urls')),    # Пример маршрута выхода
